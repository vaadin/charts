...
[NOTE]
Dynamic changes to the data will be loaded in the data series after calling the calling the [methodname]#refreshAll()# method in the [classname]#DataProvider#.
