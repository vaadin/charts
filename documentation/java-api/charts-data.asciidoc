...
// Wrap the DataSource in a ChartDataSource
ChartDataSeries<Order> chartDS = new ChartDataSeries<>(ds);
chartDS.setName("Order item quantities");
chartDS.setPlotOptions(new PlotOptionsPie());

// Set up the name and Y properties
chartDS.setYValueProvider(Order::getTotalPrice);
