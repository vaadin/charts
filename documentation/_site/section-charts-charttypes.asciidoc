...
later read or set the chart type with the ++chartType++  property of the chart
model, which you can get with [methodname]#getConfiguration().getChart()#.
...
See <<section-charts-charttypes#charts.charttypes.scatter,"Scatter Charts">> for
plot options regarding markers and other data point properties. The markers can
...
described in <<section-charts-data#charts.data.rangeseries,"Range Series">>, or
with [classname]#DataSeries#, described in
<<section-charts-data#charts.data.dataseries,"Generic Data Series">>.
...
<<section-charts-basic-use#charts.basic-use.two-dimensional,"Displaying Multiple
Series">>. Enabling stacking with [methodname]#setStacking()# in plot options
stacks the columns or bars of different series on top of each other.
...
Charts">>. They require the use of [classname]#RangeSeries# for defining the
...
While error bars technically are a chart type ( ++ChartType.ERRORBAR++ ), you
normally use them together with some primary chart type, such as a scatter or
column chart.

[[figure.charts.charttypes.errorbar]]
.Error Bars in a Scatter Chart
image::img/charts/charts-errorbar.png[, 80%, 80%]
...
<<section-charts-charttypes#charts.charttypes.errorbar,"Error Bars">>, sharing
the box and whisker elements.

[[figure.charts.charttypes.boxplot]]
.Box Plot Chart
image::img/charts/charts-boxplot.png[, 80%, 80%]

The chart type for box plot charts is ++ChartType.BOXPLOT++ . You normally have
just one data series, so it is meaningful to disable the legend.
...
.Scatter Chart
image::img/charts/charts-scatter.png[, 65%, 65%]
...
<<section-charts-charttypes#figure.charts.charttypes.scatter,"Scatter Chart">>.
...
same possibility with scatter charts in
<<section-charts-charttypes#charts.charttypes.scatter,"Scatter Charts">>, but
the bubble charts make it easier to define the size of a point by its third (Z)
...
.Bubble Chart
image::img/charts/charts-bubble.png[, 85%, 85%]
...
<<section-charts-charttypes#figure.charts.charttypes.pie,"Pie Chart">>.

[[figure.charts.charttypes.pie]]
.Pie Chart
image::img/charts/charts-pie.png[, 80%, 80%]
...
<<section-charts-charttypes#figure.charts.charttypes.pie.donut,"Overlaid Pie and
Donut Chart">>.

[[figure.charts.charttypes.pie.donut]]
.Overlaid Pie and Donut Chart
image::img/charts/charts-donut.png[, 80%, 80%]
...
<<section-charts-charttypes#figure.charts.charttypes.gauge,"A Gauge">>.

[[figure.charts.charttypes.gauge]]
.A Gauge
image::img/charts/charts-gauge.png[, 60%, 60%]
...
After the settings done in the subsequent sections, it will show as in
<<section-charts-charttypes#figure.charts.charttypes.solidgauge,"A Solid
Gauge">>.

[[figure.charts.charttypes.solidgauge]]
.A Solid Gauge
image::img/charts/charts-solidgauge.png[, 60%, 60%]
...
least need to set the shape as either " ++arc++ " or " ++solid++ ". You
...
<<section-charts-data#charts.data.rangeseries,"Range Series">>. An area range is
created with [parameter]#AREARANGE# chart type, and a column range with
[parameter]#COLUMNRANGE# chart type.
...
<<section-charts-charttypes#figure.charts.charttypes.rangecharts,"Area and
Column Range Chart">>.

[[figure.charts.charttypes.rangecharts]]
.Area and Column Range Chart
image::img/charts/charts-arearange.png[, 100%, 100%]
...
<<section-charts-charttypes#figure.charts.charttypes.polar,"Wind Rose and
Spiderweb Charts">>.

[[figure.charts.charttypes.polar]]
.Wind Rose and Spiderweb Charts
image::img/charts/charts-polarspiderweb.png[, 100%, 100%]
...
assumed to be full circle, so no angles for the pane need to be specified. Note
the style settings done in the axis in the example below: 
...
.Funnel and Pyramid Charts
image::img/charts/charts-funnel.png[, 100%, 100%]
...
options , as is done in the following example.
...
.Waterfall Charts
image::img/charts/charts-waterfall.png[, 80%, 80%]
...
[parameter]#upColor#:: Color for the positive values. For negative values, the ++negativeColor++  defined in [classname]#PlotOptionsColumn# is used.
...
[parameter]#intermediate# property to ++true++ .
...
.Heat Maps
image::img/charts/charts-heatmap.png[, 100%, 100%]
...
.Tree Maps
image::img/charts/charts-treemap.png[, 100%, 100%]

Tree maps have chart type ++TREEMAP++ . For example: 
...
image::img/charts/charts-polygon.png[, 100%, 100%]

Polygons have chart type ++POLYGON++ . For example: 
