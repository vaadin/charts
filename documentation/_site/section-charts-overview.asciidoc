...
<<section-charts-timeline#charts.timeline,"Timeline">>.

[[figure.charts.overview]]
.Vaadin Charts
image::img/charts/charts-overview.png[, 100%, 100%]
...
<<section-charts-basic-use#charts.basic-use,"Basic Use">>, we demonstrate how to
display one-dimensional data in a column graph and customize the X and Y axis
labels and titles.
...
<<section-charts-overview#figure.charts.overview.basicexample,"Basic Chart
Example">>.

[[figure.charts.overview.basicexample]]
.Basic Chart Example
image::img/charts/charts-basicexample.png[, 80%, 80%]
