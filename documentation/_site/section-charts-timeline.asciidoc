...
.Timeline Component
image::img/addons/timeline-overview.png[, 100%, 100%]
...
__Line graphs__:: Useful for representing continuous data, such as temperature changes or changes in stock price.__Bar graphs__:: Useful for representing discrete or discontinuous data, such as market share or forum posts.__Scatter graphs__:: Useful for representing discrete or discontinuous data.
...
[methodname]#setGraphStacking()# in [classname]#Timeline# to ++true++ .
...
.Scrollbar Area
image::img/addons/timeline-interaction-scrollarea.png[, 100%, 100%]
...
.Main Area
image::img/addons/timeline-interaction-mainarea.png[, 75%, 75%]
...
.Preset Zoom Buttons
image::img/addons/timeline-interaction-presetzooms.png[, 75%, 75%]
...
image::img/addons/timeline-interaction-timerange.png[, 75%, 75%]
...
.Chart Mode
image::img/addons/timeline-interaction-chartmode.png[, 85%, 85%]
...
<<section-charts-timeline#figure.charts.timeline.eventmarkers,"Timeline Event
Markers">>.

[[figure.charts.timeline.eventmarkers]]
.Timeline Event Markers
image::img/addons/timeline-event-markers.png[, 100%, 100%]
...
result is shown in
<<section-charts-timeline#figure.charts.timeline.code-example.timeline,"Timeline
Example Application">>.

[[figure.charts.timeline.code-example.timeline]]
.Timeline Example Application
image::img/timeline/timeline-example-timeline.png[, 100%, 100%]
...
.Styling Timeline
image::img/timeline/timeline-example-result.png[, 100%, 100%]
...
.Final Example
image::img/timeline/timeline-example-final.png[, 100%, 100%]
