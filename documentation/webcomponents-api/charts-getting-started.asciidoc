...
Next, modify the `<vaadin-line-chart>` element to have a `<title>` child element with the content [literal]#Hello Charts!#.
...
For further examples, please see the on-line demo at http://demo.vaadin.com/charts3[demo.vaadin.com/charts3].

The API documentation can be explored at http://demo.vaadin.com/charts3-api[demo.vaadin.com/charts3-api].
