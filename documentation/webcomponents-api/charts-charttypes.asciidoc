...
The data points in box plots have five different values of one sample: the minimum value ('low'),
...
<vaadin-spline-chart id="flags-placement">
    ...
    <data-series type="flags" name="Flags on series" on-series="dataseries">
        <data>
            <point>
                <x>1434585600000</x>
                <title>First Series Flag</title>
                <text>First Series Flag Tooltip Text</text>
            </point>
            <point>
                <x>1435017600000</x>
                <title>Second Series Flag</title>
            </point>
        </data>
    </data-series>
    <data-series type="flags" name="Flags on axis">
        <data>
            <point>
                <x>1434844800000</x>
                <title>First Axis Flag</title>
                <text>First Axis Flag Tooltip Text</text>
            </point>
            <point>
                <x>1435190400000</x>
                <title>Second Axis Flag</title>
            </point>
        </data>
    </data-series>
