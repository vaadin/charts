...
public class ChartTypes {
    public void chartTypesErrorbarSnippet1() {
        ...
        ListSeries averages = new ListSeries(-6, -6.5, -4, 3, 9, 14, 17, 16, 11,
                6, 2, -2.5);
    ...
    public void chartTypesBoxplotPlotoptionsSnippet2() {
        ...
        for (double cpointtimes[] : data) {
            ...
            series.add(new BoxPlotItem(analysis.low(), analysis.firstQuartile(),
                    analysis.median(), analysis.thirdQuartile(),
                    analysis.high()));
        }
    ...
    public void chartTypesBubbleSnippet1() {
        ...
        Object data[][] = { { "France", 181.6 }, { "United Kingdom", 34.53 },
                { "United States", 19.37 } };
        for (Object[] country : data) {
            ...
            item.setX(pos.longitude
                    * Math.cos(pos.latitude / 2.0 * (Math.PI / 160)));
    ...
    public void chartTypesGaugeAxisSnippet1() {
        ...
        yaxis.setPlotBands(
                new PlotBand[] { new PlotBand(0, 60, SolidColor.GREEN),
    ...
    public void chartTypeSpiderWebSnippet1() {
        ...
        // Create the range series
        // Source: http://ilmatieteenlaitos.fi/lampotilaennatyksia
        ListSeries series = new ListSeries("Temperature Extremes", 10.9, 11.8,
                17.5, 25.5, 31.0, 33.8, 37.2, 33.8, 28.8, 19.4, 14.1, 10.8);
        conf.addSeries(series);
    ...
    public void chartTypesWaterfall() {
        ...
        // Configure X axis
        XAxis xaxis = new XAxis();
        xaxis.setCategories("Start", "Predators", "Slaughter", "Reproduction",
                "End");
        conf.addxAxis(xaxis);
    ...
    public void chartTypesTreemap() {
        ...
        series.addAll(apples, bananas, oranges, anneA, rickA, paulA, anneB,
                rickB, paulB, anneO, rickO, paulO, susanne);
