...
import com.vaadin.addon.charts.demoandtestapp.librarydata.Helmet.Record;
import com.vaadin.addon.charts.demoandtestapp.librarydata.Helmet.Result;
    ...
    public void buttonClick(ClickEvent event) {
        try {
            if (event.getButton() == prevButton) {
                result = Helmet.search((String) searchField.getValue(),
