...
public class ResizeInsideVaadinComponent extends AbstractVaadinChartExample {
    ...
    private Number[][] getRawData() {
         ...
         * 2009-01-01
         */
        { 1230771600000d, -5.8, 0.1 }, { 1230858000000d, -4.1, 1.4 },
                { 1230944400000d, -0.5, 4.1 }, { 1231030800000d, -8.9, -0.7 },
                { 1231117200000d, -9.7, -3.7 }, { 1231203600000d, -3.4, 3.2 },
                { 1231290000000d, -3.9, -0.2 }, { 1231376400000d, -2.4, 6.7 },
                { 1231462800000d, 3.8, 6.9 }, { 1231549200000d, 3.1, 6.8 },
                { 1231635600000d, 0.0, 7.6 }, { 1231722000000d, 5.6, 9.4 },
                { 1231808400000d, 3.6, 6.5 }, { 1231894800000d, -3.6, 3.8 },
                { 1231981200000d, -6.0, -1.5 }, { 1232067600000d, -3.8, 2.4 },
                { 1232154000000d, 1.5, 4.2 }, { 1232240400000d, 0.0, 4.5 },
                { 1232326800000d, -1.1, 3.6 }, { 1232413200000d, 0.5, 5.1 },
                { 1232499600000d, 0.0, 2.5 }, { 1232586000000d, -0.6, 2.1 },
                { 1232672400000d, 0.8, 4.7 }, { 1232758800000d, 0.6, 4.4 },
                { 1232845200000d, -3.9, 1.4 }, { 1232931600000d, -4.3, 2.0 },
                { 1233018000000d, -6.1, -0.4 }, { 1233104400000d, -0.3, 1.9 },
                { 1233190800000d, -2.9, 2.7 }, { 1233277200000d, -4.0, -1.0 },
