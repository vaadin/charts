...
public class HalfJavaApiBasicBarTest extends AbstractVaadinChartExample {
    ...
    protected Component getChart() {
        ...
        ls.setData(new Integer[] { 107, 31, 635, 203, 2 });
        configuration.addSeries(ls);
        ls = new ListSeries();
        ls.setName("Year 1900");
        ls.setData(new Integer[] { 133, 156, 947, 408, 6 });
        configuration.addSeries(ls);
        ls = new ListSeries();
        ls.setName("Year 1900");
        ls.setData(new Integer[] { 973, 914, 4054, 732, 34 });
        configuration.addSeries(ls);
