...
public class TimeDataWithIrregularIntervals extends
    ...
    protected Component getChart() {
        ...
        ls.setData(new Object[][] { { d("1970,9,27"), 0 },
        ...
        ls.setData(new Object[][] { { d("1970,9,18"), 0 },
        ...
        ls.setData(new Object[][] { { d("1970,9,9"), 0 },
                ...
                { d("1971,4,16"), 0.39 }, { d("1971,4,21"), 0 } });
        configuration.addSeries(ls);
