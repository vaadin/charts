...
public class TestClassesSerializable extends TestCase {
  ...
  private static String[] EXCLUDED_PATTERNS = {"com\\.vaadin\\.addon\\.charts\\.client\\..*", "com\\.vaadin\\.addon\\.timeline\\.gwt\\.canvas\\.client\\..*",
      "com\\.vaadin\\.addon\\.timeline\\.gwt\\.client\\..*", "com\\.vaadin\\.addon\\.charts\\.demoandtestapp\\..*", "com\\.vaadin\\.addon\\.charts\\.model\\.gsonhelpers\\..*",
      "com\\.vaadin\\.addon\\.charts\\.model\\.MarkerSymbol", "com\\.vaadin\\.addon\\.charts\\.utils\\.ExampleUtil", "com\\.vaadin\\.addon\\.charts\\.model\\.Series",
      "com\\.vaadin\\.addon\\.charts\\.model\\.style\\.ThemeGradientColorSerializer", "com\\.vaadin\\.addon\\.charts\\.util\\.SVGGenerator",
      "com\\.vaadin\\.addon\\.charts\\.util\\.Util", "com\\.vaadin\\.addon\\.charts\\.util\\.SVGGenerator\\$1",};

  /**
   * Tests that all the relevant classes and interfaces under {@link #BASE_PACKAGES} implement Serializable.
   *
   * @throws Exception
   */
  ...
  /**
   * Finds the server side classes/interfaces under a class path entry - either a directory or a JAR that matches {@link #JAR_PATTERN}.
   *
   * Only classes under {@link #BASE_PACKAGES} are considered, and those matching {@link #EXCLUDED_PATTERNS} are filtered out.
   *
