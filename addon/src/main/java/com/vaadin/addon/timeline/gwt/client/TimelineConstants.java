...
public final class TimelineConstants {
    ...
    public static final String VARIABLE_VERTICAL_GRID_LINES = "gridlines";

    public static final String VARIABLE_NO_VERTICAL_GRID = "no-v-grid";

    public static final String VARIABLE_VISIBILITIES = "gvis";

    public static final String VARIABLE_LINE_GRAPH_THICKNESS = "lineGraphThickness";

    public static final String VARIABLE_CAPS = "lineCaps";
    ...
    public static final String ATTRIBUTE_UNIFORM_BARCHART = "u-bars";

    public static final String ATTRIBUTE_CHANGE_EVENT_ENABLED = "e1";

    public static final String ATTRIBUTE_EVENT_CLICK_LISTENER_ENABLED = "evcle";
    ...
    public static final String ATTRIBUTE_NO_DS_CAPTION = "nodscaption";

    public static final String ATTRIBUTE_GRAPH_SHADOWS = "shadows";

    public static final String ATTRIBUTE_OFFSCREEN_RENDERING = "offscr";

    public static final String ATTRIBUTE_VERTICAL_NUMBER_FORMAT = "vAxisNumFormat";
}
