...
public class PlotOptionsSerializer implements
        JsonSerializer<AbstractPlotOptions> {

    @Override
    public JsonElement serialize(AbstractPlotOptions src, Type typeOfSrc,
        ...
        if (src instanceof PlotOptionsArea) {
            ...
            opts.add("borderWidth", context.serialize(((PlotOptionsColumn) src)
                    .getBorderWidth()));
        ...
        opts.add("pointPlacement", context.serialize(src.getPointPlacement()));
