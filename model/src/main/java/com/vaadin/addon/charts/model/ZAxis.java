...
public class ZAxis extends Axis {
    ...
    /**
     * <p>
     * If categories are present for the zAxis, names are used instead of
    ...
    /**
     * Creates axis title with the specified text.
     *
     * @see #setTitle(AxisTitle)
     */
    ...
    /**
     * Links this Z axis to the specified Z axis.
     *
     * @see #setLinkedTo(Number)
     */
