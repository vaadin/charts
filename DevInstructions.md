...
Maintenance
=====
These instructions are for the 3.x branch that targets Vaadin 7, see master branch for Vaadin 8 specific things.
...
1. update the files <code>header.txt</code> and <code>license.txt</code> in both <code>addon/src/license/</code> and <code>model/src/license/</code> (duplicated because both jars need to contain the files)
...
1. <code>AdVaaLicen</code> tag for <code>org.apache.maven.plugins.maven-jar-plugin</code> in <code>addon/pom.xml</code>
1. Vaadin Charts documentation for [Vaadin 7](https://vaadin.com/docs/v7/charts/charts-overview)
1. general add-on licensing [documentation](https://vaadin.com/docs/v7/framework/addons)
